...
export function GoalPopup() {
  const { showGoalPopup, dismissGoalPopup } = useGame();
  ...
  }, [showGoalPopup, scaleAnim, opacityAnim]);
    ...
    <Modal visible={showGoalPopup} transparent animationType="fade">
      <View style={styles.overlay}>
        ...
        >
          ...
          <Text style={styles.message}>Phase 1 Complete!</Text>
          <TouchableOpacity style={styles.button} onPress={dismissGoalPopup} activeOpacity={0.8}>
            <Text style={styles.buttonText}>Next Phase →</Text>
          </TouchableOpacity>
        </Animated.View>
      </View>
    </Modal>
